...
def scrape_and_collect_data(url, output_folder):
    ...
    try:
        ...
        # Extract the title before removing unwanted elements
        ...
        # JSON file path
        json_path = os.path.join(output_folder, "scraped_data.json")
...
# URL for scraping
ihec_url = "https://ihec.rnu.tn/fr/ihec/mission-vision-et-valeurs"
